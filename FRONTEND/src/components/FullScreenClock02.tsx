    ...
    return (
        <div className="h-screen w-screen bg-[#FFFBDE] font-gambarino">
                ...
                <div className="absolute bottom-5 left-5">
                    <div className="flex gap-x-4 items-center">
                        <button onClick={() => nav03("/dashboard")} className="flex gap-x-1">
                            ...
                            <div className="font-poppins text-black/80">Go Back</div>
                        </button>
                        <button onClick={() => nav01("/clockgrad")} className="w-14 h-8 bg-sky-700/70  rounded-lg"></button>
                        <button onClick={() => nav02("/dark")} className="w-14 h-8 bg-black/70 rounded-lg"></button>
                    </div>
                </div>
            )}

            <div className="absolute right-6 top-6 text-[#3B3B1A] font-semibold text-2xl
            lg:text-3xl
            ">{period}</div>
            ...
            lg:flex-row lg:gap-x-10 lg:text-[270px] lg:items-center lg:justify-center lg:py-0">
                ...
                <div className=" bg-[#F2E2B1]/70 rounded-3xl tracking-wider
                ...
                ">
                    <div>{hour}</div>
                    <div className="absolute bg-[#FFFBDE]
                    w-2/3 h-2
